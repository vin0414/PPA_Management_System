                ...
                <div class="grid grid-cols-12 gap-4 mb-3">
                    ...
                    <div class="col-span-12 md:col-span-6">
                        <label class="form-control w-full">
                            ...
                            <select class="select select-bordered w-full" name="target_alignment" id="target_alignment">
                                <option value="0" disabled selected>Select score</option>
                        ...
                        <div class="card-body">
                            <div class="grid grid-cols-12 gap-4">
                                ...
                                <div class="col-span-12 md:col-span-2">
                                    ...
                                    <span class="badge badge-soft badge-neutral font-bold" id="remarks">
                                        Awaiting Response
                                    </span>
                                </div>
                            </div>
...
function computePriorityLevel() {
    ...
    $('#remarks').removeClass('badge-success border-warning badge-warning');

    if (score >= 16) {
        // High - success
        $('#level').attr("value", 1);
        $('#remarks').addClass('font-bold badge-success').text('High Priority');
    } else if (score >= 8) {
        // Moderate - warning
        $('#level').attr("value", 2);
        $('#remarks').addClass('font-bold badge-warning').text('Moderate Priority');
    } else {
        // Low - secondary
        $('#level').attr("value", 3);
        $('#remarks').addClass('font-bold badge-neutral').text('Low Priority');
    }
}
